      ...
      <div className="relative w-full max-w-3xl bg-white rounded-3xl shadow-2xl overflow-hidden max-h-[90vh] flex flex-col border border-slate-200">
        ...
        <div className="p-6 overflow-y-auto space-y-6">
          ...
          <div className="p-4 bg-slate-900 text-white rounded-2xl flex flex-col sm:flex-row items-center justify-between gap-3 text-xs">
            <div>
              <strong className="block text-emerald-400 font-bold">Documentation Swagger Interactive</strong>
              <span className="text-slate-400">Explorez et testez les endpoints REST (/api/products, /api/orders, /api/quotes).</span>
            </div>
            <a
              href="http://localhost:8000/docs"
              target="_blank"
              rel="noreferrer"
              className="px-4 py-2 bg-emerald-600 hover:bg-emerald-500 text-white rounded-xl font-bold flex items-center gap-1.5 shrink-0 transition"
            >
              <span>Accéder à /docs</span>
